...
pca9685_err_t pca9685_send_software_reset_cmd(pca9685_t const* pca9685)
{
    ...
    return pca9685_bus_write_data(pca9685, PCA9685_COMMAND_SOFTWARE_RESET, NULL, 0UL);
}
...
pca9685_err_t pca9685_get_mode1_reg(pca9685_t const* pca9685, pca9685_mode1_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_MODE1, &data, sizeof(data));
...
pca9685_err_t pca9685_set_mode1_reg(pca9685_t const* pca9685, pca9685_mode1_reg_t const* reg)
{
    ...
    return pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_MODE1, &data, sizeof(data));
}
...
pca9685_err_t pca9685_get_mode2_reg(pca9685_t const* pca9685, pca9685_mode2_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_MODE2, &data, sizeof(data));
...
pca9685_err_t pca9685_set_mode2_reg(pca9685_t const* pca9685, pca9685_mode2_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_MODE2, &data, sizeof(data));
...
pca9685_err_t pca9685_get_subadr1_reg(pca9685_t const* pca9685, pca9685_subadr1_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_SUBADR1, &data, sizeof(data));
...
pca9685_err_t pca9685_set_subadr1_reg(pca9685_t const* pca9685, pca9685_subadr1_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_SUBADR1, &data, sizeof(data));
...
pca9685_err_t pca9685_get_subadr2_reg(pca9685_t const* pca9685, pca9685_subadr2_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_SUBADR2, &data, sizeof(data));
...
pca9685_err_t pca9685_set_subadr2_reg(pca9685_t const* pca9685, pca9685_subadr2_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_SUBADR2, &data, sizeof(data));
...
pca9685_err_t pca9685_get_subadr3_reg(pca9685_t const* pca9685, pca9685_subadr3_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_SUBADR3, &data, sizeof(data));
...
pca9685_err_t pca9685_set_subadr3_reg(pca9685_t const* pca9685, pca9685_subadr3_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_SUBADR3, &data, sizeof(data));
...
pca9685_err_t pca9685_get_allcalladr_reg(pca9685_t const* pca9685, pca9685_allcalladr_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_ALLCALLADR, &data, sizeof(data));
                                         ...
                                         pca9685_allcalladr_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_ALLCALLADR, &data, sizeof(data));
                                     ...
                                     pca9685_pwm_on_reg_t* reg)
{
    ...
    pca9685_err_t err = pca9685_bus_read_data(pca9685,
...
pca9685_err_t pca9685_get_all_pwm_on_reg(pca9685_t const* pca9685, pca9685_all_pwm_on_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_ALL_PWM_ON_L, data, sizeof(data));
                                         ...
                                         pca9685_all_pwm_on_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_ALL_PWM_ON_L, data, sizeof(data));
...
pca9685_err_t pca9685_get_all_pwm_off_reg(pca9685_t const* pca9685, pca9685_all_pwm_off_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_ALL_PWM_OFF_L, data, sizeof(data));
                                          ...
                                          pca9685_all_pwm_off_reg_t const* reg)
{
    ...
    err |= pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_ALL_PWM_OFF_L, data, sizeof(data));
...
pca9685_err_t pca9685_get_pre_scale_reg(pca9685_t const* pca9685, pca9685_pre_scale_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_PRE_SCALE, &data, sizeof(data));
                                        ...
                                        pca9685_pre_scale_reg_t const* reg)
{
    ...
    return pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_PRE_SCALE, &data, sizeof(data));
}
...
pca9685_err_t pca9685_get_test_mode_reg(pca9685_t const* pca9685, pca9685_test_mode_reg_t* reg)
{
    ...
    pca9685_err_t err =
        pca9685_bus_read_data(pca9685, PCA9685_REG_ADDRESS_TEST_MODE, &data, sizeof(data));
                                        ...
                                        pca9685_test_mode_reg_t const* reg)
{
    ...
    return pca9685_bus_write_data(pca9685, PCA9685_REG_ADDRESS_TEST_MODE, &data, sizeof(data));
}
